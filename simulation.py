...
def rng_adj(win,power,K,sd_ratio):
	asy_exp=(8/np.pi)**0.5
	alpha=(K/(win-2+K))**power
	adj=0.5*asy_exp*alpha+asy_exp*((win-1)**0.5)*(1-alpha)/sd_ratio
	return adj
